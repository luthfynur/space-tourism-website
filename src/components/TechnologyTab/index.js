      ...
      {data.map((data, idx) => {
        return (
          <button
            ...
            value={idx}
            onClick={onClick}
            className={`w-[40px] h-[40px] sm:w-[60px] sm:h-[60px] xl:h-[80px] xl:w-[80px] rounded-full border-2 border-white ml-[8px] mr-[8px] xl:ml-[0px] xl:mb-[32px]
              ${
                ...
                sm:tracking-[1.5px] xl:tracking-[2px] text-center mt-auto mb-auto xl:mt-0 xl:mb-0
              `}
          >
            {idx + 1}
          </button>
